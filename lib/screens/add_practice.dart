          ...
          child: Form(
            ...
            child: Column(
              ...
              PracticeSelector(
                ...
                onChanged: (v) => ref.read(currentPracticeProvider.notifier).setPractice(v!)),
              //select emotion
              //Text('How do you feel today'),
              SizedBox(height: 16,),
              MoodSelector(
                value: practice.mood, 
                onChanged: (v) => ref.read(currentPracticeProvider.notifier).setMood(v!)),
              //enter text about feels
              //Text('Big text notes'),
              SizedBox(height: 16,),
              NotesField(
                controller: _notesController,
                onChanged: (text) => ref.read(currentPracticeProvider.notifier).setNotes(text!),),
              SaveButton(
